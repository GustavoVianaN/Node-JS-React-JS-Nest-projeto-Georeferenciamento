...
let TypesController = class TypesController {
    ...
    async createSchedule(types) {
        console.log(types);
        return await this.typesRepository.save(types);
    }
    async update(id, types) {
...
], TypesController.prototype, "findAllSchedule", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, nest_keycloak_connect_1.Roles)({ roles: ['Administrator', 'Operator'] }),
    ...
    __metadata("design:returntype", Promise)
], TypesController.prototype, "findScheduleById", null);
__decorate([
    (0, common_1.Post)(),
    (0, nest_keycloak_connect_1.Roles)({ roles: ['Administrator'] }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [types_entity_1.Types]),
    __metadata("design:returntype", Promise)
], TypesController.prototype, "createSchedule", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, nest_keycloak_connect_1.Roles)({ roles: ['Administrator'] }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, types_entity_1.Types]),
    __metadata("design:returntype", Promise)
...
exports.TypesController = TypesController = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(types_entity_1.Types)),
